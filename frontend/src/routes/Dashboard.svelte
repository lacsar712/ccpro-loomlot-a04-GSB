...
{#if stats}
  <div class="grid-stats">
    ...
    <div class="stat">
      <div class="n">{stats.openReworkCount}</div>
...
<div class="panel">
  <p style="margin:0 0 0.75rem;color:var(--indigo-mist);font-size:0.9rem;">
    业务约束：仅当染缸为 <strong>ready</strong> 或 <strong>dyeing</strong> 时可新建染程；新建后染缸自动变为 dyeing。染缸挂<strong>未结案回修复染</strong>时禁止再开新染程（409），双检色牢度达标并经主管结案后恢复。排液可用染缸「完成排液」动作。
  </p>
  <div class="toolbar">
    ...
    <a class="btn ghost" href="/reworks" use:link>回修复染</a>
  </div>
</div>
